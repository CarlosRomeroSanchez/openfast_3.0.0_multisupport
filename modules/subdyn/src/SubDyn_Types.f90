...
! =========  CB_MatArrays  =======
  TYPE, PUBLIC :: CB_MatArrays
    ...
    REAL(R8Ki) , DIMENSION(:,:), ALLOCATABLE  :: CBB_SLPM      !< FULL MBB ( no constraints applied) [-]
    REAL(R8Ki) , DIMENSION(:,:), ALLOCATABLE  :: CBM_SLPM      !< FULL MBM ( no constraints applied) [-]
    REAL(R8Ki) , DIMENSION(:,:), ALLOCATABLE  :: CMM_SLPM      !< FULL MBM ( no constraints applied) [-]
...
! =========  ElemPropType  =======
  TYPE, PUBLIC :: ElemPropType
    ...
    REAL(ReKi)  :: kh      !< SLPM Property [-]
    REAL(ReKi)  :: kr      !< SLPM Property [-]
    REAL(ReKi)  :: kt      !< SLPM Property [-]
    REAL(ReKi)  :: ch      !< SLPM Property [-]
    REAL(ReKi)  :: cr      !< SLPM Property [-]
    REAL(ReKi)  :: ct      !< SLPM Property [-]
    REAL(ReKi)  :: mh      !< SLPM Property [-]
    REAL(ReKi)  :: Ir      !< SLPM Property [-]
    REAL(ReKi)  :: mt      !< SLPM Property [-]
    REAL(ReKi)  :: h1      !< SLPM Property [-]
    REAL(ReKi)  :: h2      !< SLPM Property [-]
    REAL(ReKi)  :: h3      !< SLPM Property [-]
    REAL(ReKi)  :: Kz      !< SLPM Property [-]
    REAL(ReKi)  :: Ktor      !< SLPM Property [-]
    REAL(ReKi)  :: mz      !< SLPM Property [-]
    REAL(ReKi)  :: Itor      !< SLPM Property [-]
    REAL(ReKi)  :: Cz      !< SLPM Property [-]
    REAL(ReKi)  :: Ctor      !< SLPM Property [-]
...
! =========  SD_InitType  =======
  TYPE, PUBLIC :: SD_InitType
    ...
    INTEGER(IntKi)  :: NPropSetsSLPM      !< Number of property sets for SLPM [-]
    ...
    REAL(ReKi) , DIMENSION(:,:), ALLOCATABLE  :: PropSetsSLPM      !< Property ID and values for SLPM [-]
    ...
    INTEGER(IntKi)  :: NPropSLPM      !< Total number of property sets for SLPM [-]
    ...
    REAL(ReKi) , DIMENSION(:,:), ALLOCATABLE  :: PropsSLPM      !< Property sets and values for SLPM [-]
    REAL(R8Ki) , DIMENSION(:,:), ALLOCATABLE  :: K      !< System stiffness matrix                 [-]
    REAL(R8Ki) , DIMENSION(:,:), ALLOCATABLE  :: M      !< System mass matrix                      [-]
    REAL(R8Ki) , DIMENSION(:,:), ALLOCATABLE  :: C_SLPM      !< System mass matrix                      [-]
...
! =========  SD_ParameterType  =======
  TYPE, PUBLIC :: SD_ParameterType
    ...
    LOGICAL  :: SLPMflag      !< Existence of SLPM (flag) [-]
    ...
    REAL(ReKi) , DIMENSION(:,:), ALLOCATABLE  :: MBMCMB_SLPM      !< MBm * CmB, used for Y1 [-]
    REAL(ReKi) , DIMENSION(:,:), ALLOCATABLE  :: C1_11      !< Coefficient of x in Y1 [-]
    REAL(ReKi) , DIMENSION(:,:), ALLOCATABLE  :: C1_12      !< Coefficient of x in Y1 [-]
    REAL(ReKi) , DIMENSION(:,:), ALLOCATABLE  :: C1_12_SLPM      !< Coefficient of x in Y1 [-]
    ...
    REAL(ReKi) , DIMENSION(:,:), ALLOCATABLE  :: CBB_SLPM      !< Guyan Damping Matrix after C-B reduction [-]
    REAL(ReKi) , DIMENSION(:,:), ALLOCATABLE  :: CBM_SLPM      !< Guyan Damping Matrix after C-B reduction [-]
    REAL(ReKi) , DIMENSION(:,:), ALLOCATABLE  :: CMB_SLPM      !< Guyan Damping Matrix after C-B reduction [-]
    REAL(ReKi) , DIMENSION(:,:), ALLOCATABLE  :: CMM_SLPM      !< Guyan Damping Matrix after C-B reduction [-]
...
ENDIF
IF (ALLOCATED(SrcCB_MatArraysData%CBB_SLPM)) THEN
  i1_l = LBOUND(SrcCB_MatArraysData%CBB_SLPM,1)
  i1_u = UBOUND(SrcCB_MatArraysData%CBB_SLPM,1)
  i2_l = LBOUND(SrcCB_MatArraysData%CBB_SLPM,2)
  i2_u = UBOUND(SrcCB_MatArraysData%CBB_SLPM,2)
  IF (.NOT. ALLOCATED(DstCB_MatArraysData%CBB_SLPM)) THEN 
    ALLOCATE(DstCB_MatArraysData%CBB_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
      CALL SetErrStat(ErrID_Fatal, 'Error allocating DstCB_MatArraysData%CBB_SLPM.', ErrStat, ErrMsg,RoutineName)
      RETURN
    END IF
  END IF
    DstCB_MatArraysData%CBB_SLPM = SrcCB_MatArraysData%CBB_SLPM
ENDIF
IF (ALLOCATED(SrcCB_MatArraysData%CBM_SLPM)) THEN
  i1_l = LBOUND(SrcCB_MatArraysData%CBM_SLPM,1)
  i1_u = UBOUND(SrcCB_MatArraysData%CBM_SLPM,1)
  i2_l = LBOUND(SrcCB_MatArraysData%CBM_SLPM,2)
  i2_u = UBOUND(SrcCB_MatArraysData%CBM_SLPM,2)
  IF (.NOT. ALLOCATED(DstCB_MatArraysData%CBM_SLPM)) THEN 
    ALLOCATE(DstCB_MatArraysData%CBM_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
      CALL SetErrStat(ErrID_Fatal, 'Error allocating DstCB_MatArraysData%CBM_SLPM.', ErrStat, ErrMsg,RoutineName)
      RETURN
    END IF
  END IF
    DstCB_MatArraysData%CBM_SLPM = SrcCB_MatArraysData%CBM_SLPM
ENDIF
IF (ALLOCATED(SrcCB_MatArraysData%CMM_SLPM)) THEN
  i1_l = LBOUND(SrcCB_MatArraysData%CMM_SLPM,1)
  i1_u = UBOUND(SrcCB_MatArraysData%CMM_SLPM,1)
  i2_l = LBOUND(SrcCB_MatArraysData%CMM_SLPM,2)
  i2_u = UBOUND(SrcCB_MatArraysData%CMM_SLPM,2)
  IF (.NOT. ALLOCATED(DstCB_MatArraysData%CMM_SLPM)) THEN 
    ALLOCATE(DstCB_MatArraysData%CMM_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
      CALL SetErrStat(ErrID_Fatal, 'Error allocating DstCB_MatArraysData%CMM_SLPM.', ErrStat, ErrMsg,RoutineName)
      RETURN
    END IF
  END IF
    DstCB_MatArraysData%CMM_SLPM = SrcCB_MatArraysData%CMM_SLPM
ENDIF
...
ENDIF
IF (ALLOCATED(CB_MatArraysData%CBB_SLPM)) THEN
  DEALLOCATE(CB_MatArraysData%CBB_SLPM)
ENDIF
IF (ALLOCATED(CB_MatArraysData%CBM_SLPM)) THEN
  DEALLOCATE(CB_MatArraysData%CBM_SLPM)
ENDIF
IF (ALLOCATED(CB_MatArraysData%CMM_SLPM)) THEN
  DEALLOCATE(CB_MatArraysData%CMM_SLPM)
ENDIF
...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  END IF
  Int_BufSz   = Int_BufSz   + 1     ! CBB_SLPM allocated yes/no
  IF ( ALLOCATED(InData%CBB_SLPM) ) THEN
    Int_BufSz   = Int_BufSz   + 2*2  ! CBB_SLPM upper/lower bounds for each dimension
      Db_BufSz   = Db_BufSz   + SIZE(InData%CBB_SLPM)  ! CBB_SLPM
  END IF
  Int_BufSz   = Int_BufSz   + 1     ! CBM_SLPM allocated yes/no
  IF ( ALLOCATED(InData%CBM_SLPM) ) THEN
    Int_BufSz   = Int_BufSz   + 2*2  ! CBM_SLPM upper/lower bounds for each dimension
      Db_BufSz   = Db_BufSz   + SIZE(InData%CBM_SLPM)  ! CBM_SLPM
  END IF
  Int_BufSz   = Int_BufSz   + 1     ! CMM_SLPM allocated yes/no
  IF ( ALLOCATED(InData%CMM_SLPM) ) THEN
    Int_BufSz   = Int_BufSz   + 2*2  ! CMM_SLPM upper/lower bounds for each dimension
      Db_BufSz   = Db_BufSz   + SIZE(InData%CMM_SLPM)  ! CMM_SLPM
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      END DO
  END IF
  IF ( .NOT. ALLOCATED(InData%CBB_SLPM) ) THEN
    IntKiBuf( Int_Xferred ) = 0
    Int_Xferred = Int_Xferred + 1
  ELSE
    IntKiBuf( Int_Xferred ) = 1
    Int_Xferred = Int_Xferred + 1
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%CBB_SLPM,1)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%CBB_SLPM,1)
    Int_Xferred = Int_Xferred + 2
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%CBB_SLPM,2)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%CBB_SLPM,2)
    Int_Xferred = Int_Xferred + 2

      DO i2 = LBOUND(InData%CBB_SLPM,2), UBOUND(InData%CBB_SLPM,2)
        DO i1 = LBOUND(InData%CBB_SLPM,1), UBOUND(InData%CBB_SLPM,1)
          DbKiBuf(Db_Xferred) = InData%CBB_SLPM(i1,i2)
          Db_Xferred = Db_Xferred + 1
        END DO
      END DO
  END IF
  IF ( .NOT. ALLOCATED(InData%CBM_SLPM) ) THEN
    IntKiBuf( Int_Xferred ) = 0
    Int_Xferred = Int_Xferred + 1
  ELSE
    IntKiBuf( Int_Xferred ) = 1
    Int_Xferred = Int_Xferred + 1
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%CBM_SLPM,1)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%CBM_SLPM,1)
    Int_Xferred = Int_Xferred + 2
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%CBM_SLPM,2)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%CBM_SLPM,2)
    Int_Xferred = Int_Xferred + 2

      DO i2 = LBOUND(InData%CBM_SLPM,2), UBOUND(InData%CBM_SLPM,2)
        DO i1 = LBOUND(InData%CBM_SLPM,1), UBOUND(InData%CBM_SLPM,1)
          DbKiBuf(Db_Xferred) = InData%CBM_SLPM(i1,i2)
          Db_Xferred = Db_Xferred + 1
        END DO
      END DO
  END IF
  IF ( .NOT. ALLOCATED(InData%CMM_SLPM) ) THEN
    IntKiBuf( Int_Xferred ) = 0
    Int_Xferred = Int_Xferred + 1
  ELSE
    IntKiBuf( Int_Xferred ) = 1
    Int_Xferred = Int_Xferred + 1
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%CMM_SLPM,1)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%CMM_SLPM,1)
    Int_Xferred = Int_Xferred + 2
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%CMM_SLPM,2)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%CMM_SLPM,2)
    Int_Xferred = Int_Xferred + 2

      DO i2 = LBOUND(InData%CMM_SLPM,2), UBOUND(InData%CMM_SLPM,2)
        DO i1 = LBOUND(InData%CMM_SLPM,1), UBOUND(InData%CMM_SLPM,1)
          DbKiBuf(Db_Xferred) = InData%CMM_SLPM(i1,i2)
          Db_Xferred = Db_Xferred + 1
        END DO
      END DO
  END IF
 ...
 ! buffers to store meshes, if any
  ...
  ELSE
    ...
    END IF
      ...
      END DO
  END IF
  IF ( IntKiBuf( Int_Xferred ) == 0 ) THEN  ! CBB_SLPM not allocated
    Int_Xferred = Int_Xferred + 1
  ELSE
    Int_Xferred = Int_Xferred + 1
    i1_l = IntKiBuf( Int_Xferred    )
    ...
    i2_u = IntKiBuf( Int_Xferred + 1)
    Int_Xferred = Int_Xferred + 2
    IF (ALLOCATED(OutData%CBB_SLPM)) DEALLOCATE(OutData%CBB_SLPM)
    ALLOCATE(OutData%CBB_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
       CALL SetErrStat(ErrID_Fatal, 'Error allocating OutData%CBB_SLPM.', ErrStat, ErrMsg,RoutineName)
       RETURN
    END IF
      DO i2 = LBOUND(OutData%CBB_SLPM,2), UBOUND(OutData%CBB_SLPM,2)
        DO i1 = LBOUND(OutData%CBB_SLPM,1), UBOUND(OutData%CBB_SLPM,1)
          OutData%CBB_SLPM(i1,i2) = REAL(DbKiBuf(Db_Xferred), R8Ki)
          Db_Xferred = Db_Xferred + 1
        END DO
      END DO
  END IF
  IF ( IntKiBuf( Int_Xferred ) == 0 ) THEN  ! CBM_SLPM not allocated
    Int_Xferred = Int_Xferred + 1
  ELSE
    Int_Xferred = Int_Xferred + 1
    i1_l = IntKiBuf( Int_Xferred    )
    ...
    i2_u = IntKiBuf( Int_Xferred + 1)
    Int_Xferred = Int_Xferred + 2
    IF (ALLOCATED(OutData%CBM_SLPM)) DEALLOCATE(OutData%CBM_SLPM)
    ALLOCATE(OutData%CBM_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
       CALL SetErrStat(ErrID_Fatal, 'Error allocating OutData%CBM_SLPM.', ErrStat, ErrMsg,RoutineName)
       RETURN
    END IF
      DO i2 = LBOUND(OutData%CBM_SLPM,2), UBOUND(OutData%CBM_SLPM,2)
        DO i1 = LBOUND(OutData%CBM_SLPM,1), UBOUND(OutData%CBM_SLPM,1)
          OutData%CBM_SLPM(i1,i2) = REAL(DbKiBuf(Db_Xferred), R8Ki)
          Db_Xferred = Db_Xferred + 1
        END DO
      END DO
  END IF
  IF ( IntKiBuf( Int_Xferred ) == 0 ) THEN  ! CMM_SLPM not allocated
    Int_Xferred = Int_Xferred + 1
  ELSE
    Int_Xferred = Int_Xferred + 1
    i1_l = IntKiBuf( Int_Xferred    )
    ...
    i2_u = IntKiBuf( Int_Xferred + 1)
    Int_Xferred = Int_Xferred + 2
    IF (ALLOCATED(OutData%CMM_SLPM)) DEALLOCATE(OutData%CMM_SLPM)
    ALLOCATE(OutData%CMM_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
       CALL SetErrStat(ErrID_Fatal, 'Error allocating OutData%CMM_SLPM.', ErrStat, ErrMsg,RoutineName)
       RETURN
    END IF
      DO i2 = LBOUND(OutData%CMM_SLPM,2), UBOUND(OutData%CMM_SLPM,2)
        DO i1 = LBOUND(OutData%CMM_SLPM,1), UBOUND(OutData%CMM_SLPM,1)
          OutData%CMM_SLPM(i1,i2) = REAL(DbKiBuf(Db_Xferred), R8Ki)
          Db_Xferred = Db_Xferred + 1
        END DO
      END DO
  END IF
...
! 
   ...
   ErrMsg  = ""
    ...
    DstElemPropTypeData%kh = SrcElemPropTypeData%kh
    DstElemPropTypeData%kr = SrcElemPropTypeData%kr
    DstElemPropTypeData%kt = SrcElemPropTypeData%kt
    DstElemPropTypeData%ch = SrcElemPropTypeData%ch
    DstElemPropTypeData%cr = SrcElemPropTypeData%cr
    DstElemPropTypeData%ct = SrcElemPropTypeData%ct
    DstElemPropTypeData%mh = SrcElemPropTypeData%mh
    DstElemPropTypeData%Ir = SrcElemPropTypeData%Ir
    DstElemPropTypeData%mt = SrcElemPropTypeData%mt
    DstElemPropTypeData%h1 = SrcElemPropTypeData%h1
    DstElemPropTypeData%h2 = SrcElemPropTypeData%h2
    DstElemPropTypeData%h3 = SrcElemPropTypeData%h3
    DstElemPropTypeData%Kz = SrcElemPropTypeData%Kz
    DstElemPropTypeData%Ktor = SrcElemPropTypeData%Ktor
    DstElemPropTypeData%mz = SrcElemPropTypeData%mz
    DstElemPropTypeData%Itor = SrcElemPropTypeData%Itor
    DstElemPropTypeData%Cz = SrcElemPropTypeData%Cz
    DstElemPropTypeData%Ctor = SrcElemPropTypeData%Ctor
...
! 
 ...
 ! buffers to store subtypes, if any
  ...
  Int_BufSz  = 0
      ...
      Re_BufSz   = Re_BufSz   + 1  ! kh
      Re_BufSz   = Re_BufSz   + 1  ! kr
      Re_BufSz   = Re_BufSz   + 1  ! kt
      Re_BufSz   = Re_BufSz   + 1  ! ch
      Re_BufSz   = Re_BufSz   + 1  ! cr
      Re_BufSz   = Re_BufSz   + 1  ! ct
      Re_BufSz   = Re_BufSz   + 1  ! mh
      Re_BufSz   = Re_BufSz   + 1  ! Ir
      Re_BufSz   = Re_BufSz   + 1  ! mt
      Re_BufSz   = Re_BufSz   + 1  ! h1
      Re_BufSz   = Re_BufSz   + 1  ! h2
      Re_BufSz   = Re_BufSz   + 1  ! h3
      Re_BufSz   = Re_BufSz   + 1  ! Kz
      Re_BufSz   = Re_BufSz   + 1  ! Ktor
      Re_BufSz   = Re_BufSz   + 1  ! mz
      Re_BufSz   = Re_BufSz   + 1  ! Itor
      Re_BufSz   = Re_BufSz   + 1  ! Cz
      Re_BufSz   = Re_BufSz   + 1  ! Ctor
  IF ( Re_BufSz  .GT. 0 ) THEN 
     ALLOCATE( ReKiBuf(  Re_BufSz  ), STAT=ErrStat2 )
     IF (ErrStat2 /= 0) THEN 
       CALL SetErrStat(ErrID_Fatal, 'Error allocating ReKiBuf.', ErrStat, ErrMsg,RoutineName)
  ...
  Int_Xferred = 1
    ...
    DO i2 = LBOUND(InData%DirCos,2), UBOUND(InData%DirCos,2)
      ...
      END DO
    END DO
    ReKiBuf(Re_Xferred) = InData%kh
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%kr
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%kt
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%ch
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%cr
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%ct
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%mh
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%Ir
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%mt
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%h1
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%h2
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%h3
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%Kz
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%Ktor
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%mz
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%Itor
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%Cz
    Re_Xferred = Re_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%Ctor
    Re_Xferred = Re_Xferred + 1
 ...
 ! buffers to store meshes, if any
  ...
  Int_Xferred  = 1
    ...
    DO i2 = LBOUND(OutData%DirCos,2), UBOUND(OutData%DirCos,2)
      ...
      END DO
    END DO
    OutData%kh = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%kr = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%kt = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%ch = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%cr = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%ct = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%mh = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%Ir = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%mt = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%h1 = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%h2 = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%h3 = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%Kz = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%Ktor = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%mz = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%Itor = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%Cz = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
    OutData%Ctor = ReKiBuf(Re_Xferred)
    Re_Xferred = Re_Xferred + 1
...
! 
   ...
   ErrMsg  = ""
    ...
    DstInitTypeData%NPropSetsSLPM = SrcInitTypeData%NPropSetsSLPM
...
ENDIF
IF (ALLOCATED(SrcInitTypeData%PropSetsSLPM)) THEN
  i1_l = LBOUND(SrcInitTypeData%PropSetsSLPM,1)
  i1_u = UBOUND(SrcInitTypeData%PropSetsSLPM,1)
  i2_l = LBOUND(SrcInitTypeData%PropSetsSLPM,2)
  i2_u = UBOUND(SrcInitTypeData%PropSetsSLPM,2)
  IF (.NOT. ALLOCATED(DstInitTypeData%PropSetsSLPM)) THEN 
    ALLOCATE(DstInitTypeData%PropSetsSLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
      CALL SetErrStat(ErrID_Fatal, 'Error allocating DstInitTypeData%PropSetsSLPM.', ErrStat, ErrMsg,RoutineName)
      RETURN
    END IF
  END IF
    DstInitTypeData%PropSetsSLPM = SrcInitTypeData%PropSetsSLPM
ENDIF
...
ENDIF
    ...
    DstInitTypeData%NPropSLPM = SrcInitTypeData%NPropSLPM
...
ENDIF
IF (ALLOCATED(SrcInitTypeData%PropsSLPM)) THEN
  i1_l = LBOUND(SrcInitTypeData%PropsSLPM,1)
  i1_u = UBOUND(SrcInitTypeData%PropsSLPM,1)
  i2_l = LBOUND(SrcInitTypeData%PropsSLPM,2)
  i2_u = UBOUND(SrcInitTypeData%PropsSLPM,2)
  IF (.NOT. ALLOCATED(DstInitTypeData%PropsSLPM)) THEN 
    ALLOCATE(DstInitTypeData%PropsSLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
      CALL SetErrStat(ErrID_Fatal, 'Error allocating DstInitTypeData%PropsSLPM.', ErrStat, ErrMsg,RoutineName)
      RETURN
    END IF
  END IF
    DstInitTypeData%PropsSLPM = SrcInitTypeData%PropsSLPM
ENDIF
...
ENDIF
IF (ALLOCATED(SrcInitTypeData%C_SLPM)) THEN
  i1_l = LBOUND(SrcInitTypeData%C_SLPM,1)
  i1_u = UBOUND(SrcInitTypeData%C_SLPM,1)
  i2_l = LBOUND(SrcInitTypeData%C_SLPM,2)
  i2_u = UBOUND(SrcInitTypeData%C_SLPM,2)
  IF (.NOT. ALLOCATED(DstInitTypeData%C_SLPM)) THEN 
    ALLOCATE(DstInitTypeData%C_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
      CALL SetErrStat(ErrID_Fatal, 'Error allocating DstInitTypeData%C_SLPM.', ErrStat, ErrMsg,RoutineName)
      RETURN
    END IF
  END IF
    DstInitTypeData%C_SLPM = SrcInitTypeData%C_SLPM
ENDIF
...
ENDIF
IF (ALLOCATED(InitTypeData%PropSetsSLPM)) THEN
  DEALLOCATE(InitTypeData%PropSetsSLPM)
ENDIF
...
ENDIF
IF (ALLOCATED(InitTypeData%PropsSLPM)) THEN
  DEALLOCATE(InitTypeData%PropsSLPM)
ENDIF
...
ENDIF
IF (ALLOCATED(InitTypeData%C_SLPM)) THEN
  DEALLOCATE(InitTypeData%C_SLPM)
ENDIF
...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  Int_BufSz  = 0
      ...
      Int_BufSz  = Int_BufSz  + 1  ! NPropSetsSLPM
  ...
  END IF
  Int_BufSz   = Int_BufSz   + 1     ! PropSetsSLPM allocated yes/no
  IF ( ALLOCATED(InData%PropSetsSLPM) ) THEN
    Int_BufSz   = Int_BufSz   + 2*2  ! PropSetsSLPM upper/lower bounds for each dimension
      Re_BufSz   = Re_BufSz   + SIZE(InData%PropSetsSLPM)  ! PropSetsSLPM
  END IF
  ...
  END IF
      ...
      Int_BufSz  = Int_BufSz  + 1  ! NPropSLPM
  ...
  END IF
  Int_BufSz   = Int_BufSz   + 1     ! PropsSLPM allocated yes/no
  IF ( ALLOCATED(InData%PropsSLPM) ) THEN
    Int_BufSz   = Int_BufSz   + 2*2  ! PropsSLPM upper/lower bounds for each dimension
      Re_BufSz   = Re_BufSz   + SIZE(InData%PropsSLPM)  ! PropsSLPM
  END IF
  ...
  END IF
  Int_BufSz   = Int_BufSz   + 1     ! C_SLPM allocated yes/no
  IF ( ALLOCATED(InData%C_SLPM) ) THEN
    Int_BufSz   = Int_BufSz   + 2*2  ! C_SLPM upper/lower bounds for each dimension
      Db_BufSz   = Db_BufSz   + SIZE(InData%C_SLPM)  ! C_SLPM
  END IF
  ...
  Int_Xferred = 1
    ...
    Int_Xferred = Int_Xferred + 1
    IntKiBuf(Int_Xferred) = InData%NPropSetsSLPM
    Int_Xferred = Int_Xferred + 1
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      END DO
  END IF
  IF ( .NOT. ALLOCATED(InData%PropSetsSLPM) ) THEN
    IntKiBuf( Int_Xferred ) = 0
    Int_Xferred = Int_Xferred + 1
  ELSE
    IntKiBuf( Int_Xferred ) = 1
    Int_Xferred = Int_Xferred + 1
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%PropSetsSLPM,1)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%PropSetsSLPM,1)
    Int_Xferred = Int_Xferred + 2
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%PropSetsSLPM,2)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%PropSetsSLPM,2)
    Int_Xferred = Int_Xferred + 2

      DO i2 = LBOUND(InData%PropSetsSLPM,2), UBOUND(InData%PropSetsSLPM,2)
        DO i1 = LBOUND(InData%PropSetsSLPM,1), UBOUND(InData%PropSetsSLPM,1)
          ReKiBuf(Re_Xferred) = InData%PropSetsSLPM(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  END IF
    ...
    Int_Xferred = Int_Xferred + 1
    IntKiBuf(Int_Xferred) = InData%NPropSLPM
    Int_Xferred = Int_Xferred + 1
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      END DO
  END IF
  IF ( .NOT. ALLOCATED(InData%PropsSLPM) ) THEN
    IntKiBuf( Int_Xferred ) = 0
    Int_Xferred = Int_Xferred + 1
  ELSE
    IntKiBuf( Int_Xferred ) = 1
    Int_Xferred = Int_Xferred + 1
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%PropsSLPM,1)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%PropsSLPM,1)
    Int_Xferred = Int_Xferred + 2
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%PropsSLPM,2)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%PropsSLPM,2)
    Int_Xferred = Int_Xferred + 2

      DO i2 = LBOUND(InData%PropsSLPM,2), UBOUND(InData%PropsSLPM,2)
        DO i1 = LBOUND(InData%PropsSLPM,1), UBOUND(InData%PropsSLPM,1)
          ReKiBuf(Re_Xferred) = InData%PropsSLPM(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      END DO
  END IF
  IF ( .NOT. ALLOCATED(InData%C_SLPM) ) THEN
    IntKiBuf( Int_Xferred ) = 0
    Int_Xferred = Int_Xferred + 1
  ELSE
    IntKiBuf( Int_Xferred ) = 1
    Int_Xferred = Int_Xferred + 1
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%C_SLPM,1)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%C_SLPM,1)
    Int_Xferred = Int_Xferred + 2
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%C_SLPM,2)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%C_SLPM,2)
    Int_Xferred = Int_Xferred + 2

      DO i2 = LBOUND(InData%C_SLPM,2), UBOUND(InData%C_SLPM,2)
        DO i1 = LBOUND(InData%C_SLPM,1), UBOUND(InData%C_SLPM,1)
          DbKiBuf(Db_Xferred) = InData%C_SLPM(i1,i2)
          Db_Xferred = Db_Xferred + 1
        END DO
      END DO
  END IF
 ...
 ! buffers to store meshes, if any
  ...
  Int_Xferred  = 1
    ...
    Int_Xferred = Int_Xferred + 1
    OutData%NPropSetsSLPM = IntKiBuf(Int_Xferred)
    Int_Xferred = Int_Xferred + 1
  ...
  ELSE
    ...
    END IF
      ...
      END DO
  END IF
  IF ( IntKiBuf( Int_Xferred ) == 0 ) THEN  ! PropSetsSLPM not allocated
    Int_Xferred = Int_Xferred + 1
  ELSE
    Int_Xferred = Int_Xferred + 1
    i1_l = IntKiBuf( Int_Xferred    )
    ...
    i2_u = IntKiBuf( Int_Xferred + 1)
    Int_Xferred = Int_Xferred + 2
    IF (ALLOCATED(OutData%PropSetsSLPM)) DEALLOCATE(OutData%PropSetsSLPM)
    ALLOCATE(OutData%PropSetsSLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
       CALL SetErrStat(ErrID_Fatal, 'Error allocating OutData%PropSetsSLPM.', ErrStat, ErrMsg,RoutineName)
       RETURN
    END IF
      DO i2 = LBOUND(OutData%PropSetsSLPM,2), UBOUND(OutData%PropSetsSLPM,2)
        DO i1 = LBOUND(OutData%PropSetsSLPM,1), UBOUND(OutData%PropSetsSLPM,1)
          OutData%PropSetsSLPM(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  END IF
    ...
    Int_Xferred = Int_Xferred + 1
    OutData%NPropSLPM = IntKiBuf(Int_Xferred)
    Int_Xferred = Int_Xferred + 1
  ...
  ELSE
    ...
    END IF
      ...
      END DO
  END IF
  IF ( IntKiBuf( Int_Xferred ) == 0 ) THEN  ! PropsSLPM not allocated
    Int_Xferred = Int_Xferred + 1
  ELSE
    Int_Xferred = Int_Xferred + 1
    i1_l = IntKiBuf( Int_Xferred    )
    ...
    i2_u = IntKiBuf( Int_Xferred + 1)
    Int_Xferred = Int_Xferred + 2
    IF (ALLOCATED(OutData%PropsSLPM)) DEALLOCATE(OutData%PropsSLPM)
    ALLOCATE(OutData%PropsSLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
       CALL SetErrStat(ErrID_Fatal, 'Error allocating OutData%PropsSLPM.', ErrStat, ErrMsg,RoutineName)
       RETURN
    END IF
      DO i2 = LBOUND(OutData%PropsSLPM,2), UBOUND(OutData%PropsSLPM,2)
        DO i1 = LBOUND(OutData%PropsSLPM,1), UBOUND(OutData%PropsSLPM,1)
          OutData%PropsSLPM(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    END IF
      ...
      END DO
  END IF
  IF ( IntKiBuf( Int_Xferred ) == 0 ) THEN  ! C_SLPM not allocated
    Int_Xferred = Int_Xferred + 1
  ELSE
    Int_Xferred = Int_Xferred + 1
    i1_l = IntKiBuf( Int_Xferred    )
    ...
    i2_u = IntKiBuf( Int_Xferred + 1)
    Int_Xferred = Int_Xferred + 2
    IF (ALLOCATED(OutData%C_SLPM)) DEALLOCATE(OutData%C_SLPM)
    ALLOCATE(OutData%C_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
       CALL SetErrStat(ErrID_Fatal, 'Error allocating OutData%C_SLPM.', ErrStat, ErrMsg,RoutineName)
       RETURN
    END IF
      DO i2 = LBOUND(OutData%C_SLPM,2), UBOUND(OutData%C_SLPM,2)
        DO i1 = LBOUND(OutData%C_SLPM,1), UBOUND(OutData%C_SLPM,1)
          OutData%C_SLPM(i1,i2) = REAL(DbKiBuf(Db_Xferred), R8Ki)
          Db_Xferred = Db_Xferred + 1
        END DO
      END DO
  END IF
...
! 
   ...
   ErrMsg  = ""
    ...
    DstParamData%SLPMflag = SrcParamData%SLPMflag
...
ENDIF
IF (ALLOCATED(SrcParamData%MBMCMB_SLPM)) THEN
  i1_l = LBOUND(SrcParamData%MBMCMB_SLPM,1)
  i1_u = UBOUND(SrcParamData%MBMCMB_SLPM,1)
  i2_l = LBOUND(SrcParamData%MBMCMB_SLPM,2)
  i2_u = UBOUND(SrcParamData%MBMCMB_SLPM,2)
  IF (.NOT. ALLOCATED(DstParamData%MBMCMB_SLPM)) THEN 
    ALLOCATE(DstParamData%MBMCMB_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
      CALL SetErrStat(ErrID_Fatal, 'Error allocating DstParamData%MBMCMB_SLPM.', ErrStat, ErrMsg,RoutineName)
      RETURN
    END IF
  END IF
    DstParamData%MBMCMB_SLPM = SrcParamData%MBMCMB_SLPM
ENDIF
...
ENDIF
IF (ALLOCATED(SrcParamData%C1_12_SLPM)) THEN
  i1_l = LBOUND(SrcParamData%C1_12_SLPM,1)
  i1_u = UBOUND(SrcParamData%C1_12_SLPM,1)
  i2_l = LBOUND(SrcParamData%C1_12_SLPM,2)
  i2_u = UBOUND(SrcParamData%C1_12_SLPM,2)
  IF (.NOT. ALLOCATED(DstParamData%C1_12_SLPM)) THEN 
    ALLOCATE(DstParamData%C1_12_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
      CALL SetErrStat(ErrID_Fatal, 'Error allocating DstParamData%C1_12_SLPM.', ErrStat, ErrMsg,RoutineName)
      RETURN
    END IF
  END IF
    DstParamData%C1_12_SLPM = SrcParamData%C1_12_SLPM
ENDIF
...
ENDIF
IF (ALLOCATED(SrcParamData%CBB_SLPM)) THEN
  i1_l = LBOUND(SrcParamData%CBB_SLPM,1)
  i1_u = UBOUND(SrcParamData%CBB_SLPM,1)
  i2_l = LBOUND(SrcParamData%CBB_SLPM,2)
  i2_u = UBOUND(SrcParamData%CBB_SLPM,2)
  IF (.NOT. ALLOCATED(DstParamData%CBB_SLPM)) THEN 
    ALLOCATE(DstParamData%CBB_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
      CALL SetErrStat(ErrID_Fatal, 'Error allocating DstParamData%CBB_SLPM.', ErrStat, ErrMsg,RoutineName)
      RETURN
    END IF
  END IF
    DstParamData%CBB_SLPM = SrcParamData%CBB_SLPM
ENDIF
IF (ALLOCATED(SrcParamData%CBM_SLPM)) THEN
  i1_l = LBOUND(SrcParamData%CBM_SLPM,1)
  i1_u = UBOUND(SrcParamData%CBM_SLPM,1)
  i2_l = LBOUND(SrcParamData%CBM_SLPM,2)
  i2_u = UBOUND(SrcParamData%CBM_SLPM,2)
  IF (.NOT. ALLOCATED(DstParamData%CBM_SLPM)) THEN 
    ALLOCATE(DstParamData%CBM_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
      CALL SetErrStat(ErrID_Fatal, 'Error allocating DstParamData%CBM_SLPM.', ErrStat, ErrMsg,RoutineName)
      RETURN
    END IF
  END IF
    DstParamData%CBM_SLPM = SrcParamData%CBM_SLPM
ENDIF
IF (ALLOCATED(SrcParamData%CMB_SLPM)) THEN
  i1_l = LBOUND(SrcParamData%CMB_SLPM,1)
  i1_u = UBOUND(SrcParamData%CMB_SLPM,1)
  i2_l = LBOUND(SrcParamData%CMB_SLPM,2)
  i2_u = UBOUND(SrcParamData%CMB_SLPM,2)
  IF (.NOT. ALLOCATED(DstParamData%CMB_SLPM)) THEN 
    ALLOCATE(DstParamData%CMB_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
      CALL SetErrStat(ErrID_Fatal, 'Error allocating DstParamData%CMB_SLPM.', ErrStat, ErrMsg,RoutineName)
      RETURN
    END IF
  END IF
    DstParamData%CMB_SLPM = SrcParamData%CMB_SLPM
ENDIF
IF (ALLOCATED(SrcParamData%CMM_SLPM)) THEN
  i1_l = LBOUND(SrcParamData%CMM_SLPM,1)
  i1_u = UBOUND(SrcParamData%CMM_SLPM,1)
  i2_l = LBOUND(SrcParamData%CMM_SLPM,2)
  i2_u = UBOUND(SrcParamData%CMM_SLPM,2)
  IF (.NOT. ALLOCATED(DstParamData%CMM_SLPM)) THEN 
    ALLOCATE(DstParamData%CMM_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
      CALL SetErrStat(ErrID_Fatal, 'Error allocating DstParamData%CMM_SLPM.', ErrStat, ErrMsg,RoutineName)
      RETURN
    END IF
  END IF
    DstParamData%CMM_SLPM = SrcParamData%CMM_SLPM
ENDIF
...
ENDIF
IF (ALLOCATED(ParamData%MBMCMB_SLPM)) THEN
  DEALLOCATE(ParamData%MBMCMB_SLPM)
ENDIF
...
ENDIF
IF (ALLOCATED(ParamData%C1_12_SLPM)) THEN
  DEALLOCATE(ParamData%C1_12_SLPM)
ENDIF
...
ENDIF
IF (ALLOCATED(ParamData%CBB_SLPM)) THEN
  DEALLOCATE(ParamData%CBB_SLPM)
ENDIF
IF (ALLOCATED(ParamData%CBM_SLPM)) THEN
  DEALLOCATE(ParamData%CBM_SLPM)
ENDIF
IF (ALLOCATED(ParamData%CMB_SLPM)) THEN
  DEALLOCATE(ParamData%CMB_SLPM)
ENDIF
IF (ALLOCATED(ParamData%CMM_SLPM)) THEN
  DEALLOCATE(ParamData%CMM_SLPM)
ENDIF
...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  Int_BufSz  = 0
      ...
      Int_BufSz  = Int_BufSz  + 1  ! SLPMflag
  ...
  END IF
  Int_BufSz   = Int_BufSz   + 1     ! MBMCMB_SLPM allocated yes/no
  IF ( ALLOCATED(InData%MBMCMB_SLPM) ) THEN
    Int_BufSz   = Int_BufSz   + 2*2  ! MBMCMB_SLPM upper/lower bounds for each dimension
      Re_BufSz   = Re_BufSz   + SIZE(InData%MBMCMB_SLPM)  ! MBMCMB_SLPM
  END IF
  ...
  END IF
  Int_BufSz   = Int_BufSz   + 1     ! C1_12_SLPM allocated yes/no
  IF ( ALLOCATED(InData%C1_12_SLPM) ) THEN
    Int_BufSz   = Int_BufSz   + 2*2  ! C1_12_SLPM upper/lower bounds for each dimension
      Re_BufSz   = Re_BufSz   + SIZE(InData%C1_12_SLPM)  ! C1_12_SLPM
  END IF
  ...
  IF ( ALLOCATED(InData%CBB_SLPM) ) THEN
    Int_BufSz   = Int_BufSz   + 2*2  ! CBB_SLPM upper/lower bounds for each dimension
      Re_BufSz   = Re_BufSz   + SIZE(InData%CBB_SLPM)  ! CBB_SLPM
  END IF
  Int_BufSz   = Int_BufSz   + 1     ! CBM_SLPM allocated yes/no
  IF ( ALLOCATED(InData%CBM_SLPM) ) THEN
    Int_BufSz   = Int_BufSz   + 2*2  ! CBM_SLPM upper/lower bounds for each dimension
      Re_BufSz   = Re_BufSz   + SIZE(InData%CBM_SLPM)  ! CBM_SLPM
  END IF
  Int_BufSz   = Int_BufSz   + 1     ! CMB_SLPM allocated yes/no
  IF ( ALLOCATED(InData%CMB_SLPM) ) THEN
    Int_BufSz   = Int_BufSz   + 2*2  ! CMB_SLPM upper/lower bounds for each dimension
      Re_BufSz   = Re_BufSz   + SIZE(InData%CMB_SLPM)  ! CMB_SLPM
  END IF
  Int_BufSz   = Int_BufSz   + 1     ! CMM_SLPM allocated yes/no
  IF ( ALLOCATED(InData%CMM_SLPM) ) THEN
    Int_BufSz   = Int_BufSz   + 2*2  ! CMM_SLPM upper/lower bounds for each dimension
      Re_BufSz   = Re_BufSz   + SIZE(InData%CMM_SLPM)  ! CMM_SLPM
  END IF
  ...
  Int_Xferred = 1
    ...
    Int_Xferred = Int_Xferred + 1
    IntKiBuf(Int_Xferred) = TRANSFER(InData%SLPMflag, IntKiBuf(1))
    Int_Xferred = Int_Xferred + 1
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      END DO
  END IF
  IF ( .NOT. ALLOCATED(InData%MBMCMB_SLPM) ) THEN
    IntKiBuf( Int_Xferred ) = 0
    Int_Xferred = Int_Xferred + 1
  ELSE
    IntKiBuf( Int_Xferred ) = 1
    Int_Xferred = Int_Xferred + 1
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%MBMCMB_SLPM,1)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%MBMCMB_SLPM,1)
    Int_Xferred = Int_Xferred + 2
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%MBMCMB_SLPM,2)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%MBMCMB_SLPM,2)
    Int_Xferred = Int_Xferred + 2

      DO i2 = LBOUND(InData%MBMCMB_SLPM,2), UBOUND(InData%MBMCMB_SLPM,2)
        DO i1 = LBOUND(InData%MBMCMB_SLPM,1), UBOUND(InData%MBMCMB_SLPM,1)
          ReKiBuf(Re_Xferred) = InData%MBMCMB_SLPM(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      END DO
  END IF
  IF ( .NOT. ALLOCATED(InData%C1_12_SLPM) ) THEN
    IntKiBuf( Int_Xferred ) = 0
    Int_Xferred = Int_Xferred + 1
  ELSE
    IntKiBuf( Int_Xferred ) = 1
    Int_Xferred = Int_Xferred + 1
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%C1_12_SLPM,1)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%C1_12_SLPM,1)
    Int_Xferred = Int_Xferred + 2
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%C1_12_SLPM,2)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%C1_12_SLPM,2)
    Int_Xferred = Int_Xferred + 2

      DO i2 = LBOUND(InData%C1_12_SLPM,2), UBOUND(InData%C1_12_SLPM,2)
        DO i1 = LBOUND(InData%C1_12_SLPM,1), UBOUND(InData%C1_12_SLPM,1)
          ReKiBuf(Re_Xferred) = InData%C1_12_SLPM(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%D2_62,2), UBOUND(InData%D2_62,2)
        DO i1 = LBOUND(InData%D2_62,1), UBOUND(InData%D2_62,1)
          ReKiBuf(Re_Xferred) = InData%D2_62(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%CBB_SLPM,2), UBOUND(InData%CBB_SLPM,2)
        DO i1 = LBOUND(InData%CBB_SLPM,1), UBOUND(InData%CBB_SLPM,1)
          ReKiBuf(Re_Xferred) = InData%CBB_SLPM(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%CBM_SLPM,2), UBOUND(InData%CBM_SLPM,2)
        DO i1 = LBOUND(InData%CBM_SLPM,1), UBOUND(InData%CBM_SLPM,1)
          ReKiBuf(Re_Xferred) = InData%CBM_SLPM(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  IF ( .NOT. ALLOCATED(InData%CMB_SLPM) ) THEN
    IntKiBuf( Int_Xferred ) = 0
    Int_Xferred = Int_Xferred + 1
  ELSE
    IntKiBuf( Int_Xferred ) = 1
    Int_Xferred = Int_Xferred + 1
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%CMB_SLPM,1)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%CMB_SLPM,1)
    Int_Xferred = Int_Xferred + 2
    IntKiBuf( Int_Xferred    ) = LBOUND(InData%CMB_SLPM,2)
    IntKiBuf( Int_Xferred + 1) = UBOUND(InData%CMB_SLPM,2)
    Int_Xferred = Int_Xferred + 2

      DO i2 = LBOUND(InData%CMB_SLPM,2), UBOUND(InData%CMB_SLPM,2)
        DO i1 = LBOUND(InData%CMB_SLPM,1), UBOUND(InData%CMB_SLPM,1)
          ReKiBuf(Re_Xferred) = InData%CMB_SLPM(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%CMM_SLPM,2), UBOUND(InData%CMM_SLPM,2)
        DO i1 = LBOUND(InData%CMM_SLPM,1), UBOUND(InData%CMM_SLPM,1)
          ReKiBuf(Re_Xferred) = InData%CMM_SLPM(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
 ...
 ! buffers to store meshes, if any
  ...
  Int_Xferred  = 1
    ...
    Int_Xferred = Int_Xferred + 1
    OutData%SLPMflag = TRANSFER(IntKiBuf(Int_Xferred), OutData%SLPMflag)
    Int_Xferred = Int_Xferred + 1
  ...
  ELSE
    ...
    END IF
      ...
      END DO
  END IF
  IF ( IntKiBuf( Int_Xferred ) == 0 ) THEN  ! MBMCMB_SLPM not allocated
    Int_Xferred = Int_Xferred + 1
  ELSE
    Int_Xferred = Int_Xferred + 1
    i1_l = IntKiBuf( Int_Xferred    )
    ...
    i2_u = IntKiBuf( Int_Xferred + 1)
    Int_Xferred = Int_Xferred + 2
    IF (ALLOCATED(OutData%MBMCMB_SLPM)) DEALLOCATE(OutData%MBMCMB_SLPM)
    ALLOCATE(OutData%MBMCMB_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
       CALL SetErrStat(ErrID_Fatal, 'Error allocating OutData%MBMCMB_SLPM.', ErrStat, ErrMsg,RoutineName)
       RETURN
    END IF
      DO i2 = LBOUND(OutData%MBMCMB_SLPM,2), UBOUND(OutData%MBMCMB_SLPM,2)
        DO i1 = LBOUND(OutData%MBMCMB_SLPM,1), UBOUND(OutData%MBMCMB_SLPM,1)
          OutData%MBMCMB_SLPM(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    END IF
      ...
      END DO
  END IF
  IF ( IntKiBuf( Int_Xferred ) == 0 ) THEN  ! C1_12_SLPM not allocated
    Int_Xferred = Int_Xferred + 1
  ELSE
    Int_Xferred = Int_Xferred + 1
    i1_l = IntKiBuf( Int_Xferred    )
    ...
    i2_u = IntKiBuf( Int_Xferred + 1)
    Int_Xferred = Int_Xferred + 2
    IF (ALLOCATED(OutData%C1_12_SLPM)) DEALLOCATE(OutData%C1_12_SLPM)
    ALLOCATE(OutData%C1_12_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
       CALL SetErrStat(ErrID_Fatal, 'Error allocating OutData%C1_12_SLPM.', ErrStat, ErrMsg,RoutineName)
       RETURN
    END IF
      DO i2 = LBOUND(OutData%C1_12_SLPM,2), UBOUND(OutData%C1_12_SLPM,2)
        DO i1 = LBOUND(OutData%C1_12_SLPM,1), UBOUND(OutData%C1_12_SLPM,1)
          OutData%C1_12_SLPM(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i2 = LBOUND(OutData%D2_62,2), UBOUND(OutData%D2_62,2)
        DO i1 = LBOUND(OutData%D2_62,1), UBOUND(OutData%D2_62,1)
          OutData%D2_62(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    END IF
      DO i2 = LBOUND(OutData%CBB_SLPM,2), UBOUND(OutData%CBB_SLPM,2)
        DO i1 = LBOUND(OutData%CBB_SLPM,1), UBOUND(OutData%CBB_SLPM,1)
          OutData%CBB_SLPM(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    END IF
      DO i2 = LBOUND(OutData%CBM_SLPM,2), UBOUND(OutData%CBM_SLPM,2)
        DO i1 = LBOUND(OutData%CBM_SLPM,1), UBOUND(OutData%CBM_SLPM,1)
          OutData%CBM_SLPM(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  IF ( IntKiBuf( Int_Xferred ) == 0 ) THEN  ! CMB_SLPM not allocated
    Int_Xferred = Int_Xferred + 1
  ELSE
    Int_Xferred = Int_Xferred + 1
    i1_l = IntKiBuf( Int_Xferred    )
    ...
    i2_u = IntKiBuf( Int_Xferred + 1)
    Int_Xferred = Int_Xferred + 2
    IF (ALLOCATED(OutData%CMB_SLPM)) DEALLOCATE(OutData%CMB_SLPM)
    ALLOCATE(OutData%CMB_SLPM(i1_l:i1_u,i2_l:i2_u),STAT=ErrStat2)
    IF (ErrStat2 /= 0) THEN 
       CALL SetErrStat(ErrID_Fatal, 'Error allocating OutData%CMB_SLPM.', ErrStat, ErrMsg,RoutineName)
       RETURN
    END IF
      DO i2 = LBOUND(OutData%CMB_SLPM,2), UBOUND(OutData%CMB_SLPM,2)
        DO i1 = LBOUND(OutData%CMB_SLPM,1), UBOUND(OutData%CMB_SLPM,1)
          OutData%CMB_SLPM(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
  ...
  ELSE
    ...
    END IF
      DO i2 = LBOUND(OutData%CMM_SLPM,2), UBOUND(OutData%CMM_SLPM,2)
        DO i1 = LBOUND(OutData%CMM_SLPM,1), UBOUND(OutData%CMM_SLPM,1)
          OutData%CMM_SLPM(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
